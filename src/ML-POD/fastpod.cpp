...
void buildTwoBody(double *rijs, double *besselparams, int nbesselpars, int bdegree, int adegree, int npairs, int nrbfmax, double rin, double rcut, double *phi, int ns, double *coeff2, double *coeff3, double * coeff23, double *coeff33, double * coeff4, double *coeff34, double *coeff44,  int * ti, int *tj, int *pq, int * pn3, int * pc3, int * elemindex, int nrbf2, int k3, int nrbf3, int nelements, int nd23, int nd33, int nd34, int n32, int n23, int n33, int n43, int n34, int n44,int nabf3, double *fij, double *e2, double *e3, double *sumU, double *U, double *d2, double *dd2, double * d3, double * dd3, double * cU) {
  ...
  poddescTwoBody(rijs_buffer, besselparams_buffer, nbesselpars, bdegree, adegree, npairs, nrbfmax, rin, rcut, phi_buffer, ns, coeff2_buffer, ti_buffer, tj_buffer, nrbf2, k3, pq_buffer, pn3_buffer, pc3_buffer, elemindex_buffer, nrbf3, nelements, nd23, nd33, nd34, n32, n23, n33, n43, n34, n44, nabf3, coeff3_buffer, coeff23_buffer, coeff33_buffer, coeff4_buffer, coeff34_buffer, coeff44_buffer, fij_buffer, e2_buffer, sumU_buffer, U_buffer, d2_buffer, dd2_buffer, d3_buffer, dd3_buffer, cU_buffer, e3_buffer);
}
        ...
        int *ti, int *tj, int Nj)
{
  ...
  if (nd3 > 0 && nd23 > 0 && useHalide) {
    ...
    buildTwoBody(rij, besselparams, nbesselpars, pdegree[0], pdegree[1], Nj, nrbfmax, rin, rcut, Phi, ns, &coeff2[nl2*t0], &coeff3[nl3*t0], coeff23, coeff33, coeff4, coeff34, coeff44, ti, tj, pq3, pn3, pc3, elemindex, nrbf2, K3, nrbf3, nelements, nd23, nd33, nd34,n32, n23, n33, n43, n34, n44, nabf3, fij, &e2, &e3, sumU, U, d2, dd2, d3, dd3, cU);
