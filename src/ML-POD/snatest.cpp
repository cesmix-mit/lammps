...
SNATEST::SNATEST(LAMMPS* lmp, double rfac0_in, int twojmax_in,
...
void SNATEST::build_indexlist()
{
  ...
  idxb_max = idxb_count;
  idxb = new SNATEST_BINDICES[idxb_max];
  ...
  idxz_max = idxz_count;
  idxz = new SNATEST_ZINDICES[idxz_max];
...
void SNATEST::grow_rij(int newnmax)
{
...
void SNATEST::compute_ui(int jnum, int ielem)
{
...
void SNATEST::compute_yi(const double* beta)
{
  int jju;
  double betaj;
  int itriple;
...
void SNATEST::compute_deidrj(double* dedr)
{
...
void SNATEST::compute_bi(int ielem) {
  // for j1 = 0,...,twojmax
  //   for j2 = 0,twojmax
...
void SNATEST::compute_duidrj(int jj)
{
...
void SNATEST::zero_uarraytot(int ielem)
{
...
void SNATEST::add_uarraytot(double r, int jj)
{
  double sfac;
  int jelem;
...
void SNATEST::compute_uarray(double x, double y, double z,
...
void SNATEST::compute_duarray(double x, double y, double z,
...
double SNATEST::memory_usage()
{
  ...
  bytes += (double)idxz_max * sizeof(SNATEST_ZINDICES);              // idxz
  bytes += (double)idxb_max * sizeof(SNATEST_BINDICES);              // idxb
...
void SNATEST::create_twojmax_arrays()
{
  int jdimpq = twojmax + 2;
...
void SNATEST::destroy_twojmax_arrays()
{
...
double SNATEST::deltacg(int j1, int j2, int j)
{
...
void SNATEST::init_clebsch_gordan()
{
...
void SNATEST::print_clebsch_gordan()
{
  if (comm->me) return;
...
double SNATEST::compute_sfac(double r, double rcut, double sinner, double dinner)
{
  double sfac;
...
double SNATEST::compute_dsfac(double r, double rcut, double sinner, double dinner)
{
